...
def main():
    ...
    # ---------------------------------------------------------------
    # 7. Build and train the SimpleRNN model
    # ---------------------------------------------------------------
    ...
    print(classification_report(y_test_arr, y_pred_rnn, target_names=["Negative", "Positive"]))
    print("Accuracy:", accuracy_score(y_test_arr, y_pred_rnn))
    print("Confusion matrix:\n", confusion_matrix(y_test_arr, y_pred_rnn))
    ...
    print("Saved rnn_sentiment_model.h5 and tokenizer.pkl")
